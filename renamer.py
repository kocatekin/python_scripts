    ...
    for file in os.listdir():
        if file.endswith(formatname):
            ...
            try:
                ...
                continue
            print(f"file name changed from {file} to {newname}")
